    ...
    if dataset_config["name"] in ['sbm', 'comm20', 'planar', 'gdss-comm20', 'gdss-ego']:
        ...
        model_kwargs = {'dataset_infos': dataset_infos, 'visualization_tools': visualization_tools,
            ...
            if dataset_config["name"] == 'qm9':
                ...
                #                                             dataset_infos=dataset_infos, train=True, evaluate_dataset=False)
                # test_smiles = qm9_dataset.get_train_smiles(cfg=cfg, train_dataloader=datamodule.test_dataloader(),
                #                                             dataset_infos=dataset_infos, train=False, evaluate_dataset=False)
                ...
                #                                             dataset_infos=dataset_infos, train=True, evaluate_dataset=False)
                # test_smiles = zinc250k_dataset.get_train_smiles(cfg=cfg, train_dataloader=datamodule.test_dataloader(),
                #                                             dataset_infos=dataset_infos, train=False, evaluate_dataset=False)
            else:
